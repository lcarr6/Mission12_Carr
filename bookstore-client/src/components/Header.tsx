...
export const Header: React.FC = () => {
  return (
    <>
      ...
      <div className="d-md-none bg-light p-2 border-bottom shadow-sm">
        <div className="container">
          <CartSummary />
        </div>
      </div>
